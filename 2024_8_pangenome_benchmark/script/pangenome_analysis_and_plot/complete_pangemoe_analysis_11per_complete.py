...
# input
input_path = '../../source_data/pangenome_graph/11per_complete'
output_path = '../../result/pangenome_analysis_and_plot/11per_complete'
...
cuttlefish_file_path = os.path.join(input_path, 'cuttlefish_combination.gfa1')
