...
# input
input_path = '../../source_data/pangenome_graph/pure_complete'
output_path = '../../result/pangenome_analysis_and_plot/pure_complete'
...
cuttlefish_file_path = os.path.join(input_path, 'cuttlefish_complete_2.gfa1')
