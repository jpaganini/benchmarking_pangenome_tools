...
# input
input_path = '../../source_data/pangenome_graph/50per_complete'
output_path = '../../result/pangenome_analysis_and_plot/50per_complete'
...
cuttlefish_file_path = os.path.join(input_path, 'combination_88_complete.gfa1')
