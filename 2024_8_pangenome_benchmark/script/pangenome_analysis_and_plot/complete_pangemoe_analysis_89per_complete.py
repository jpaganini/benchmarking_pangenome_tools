...
# input
input_path = '../../source_data/pangenome_graph/89per_complete'
output_path = '../../result/pangenome_analysis_and_plot/89per_complete'
...
cuttlefish_file_path = os.path.join(input_path, 'cuttlefish_20_assembly.gfa1')
