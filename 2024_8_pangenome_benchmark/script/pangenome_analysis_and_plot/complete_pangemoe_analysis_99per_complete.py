...
# input
input_path = '../../source_data/pangenome_graph/99per_complete'
output_path = '../../result/pangenome_analysis_and_plot/99per_complete'
...
cuttlefish_file_path = os.path.join(input_path, 'combination_2_assembly.gfa1')
